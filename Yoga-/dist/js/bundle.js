...
var ajaxForm = function ajaxForm() {
  ...
  var sendForm = function sendForm(elem, formInput) {
    elem.addEventListener('submit', function (e) {
      ...
      var postData = function postData(json) {
      ...
      postData(jsonStr).then(function () {
        return statusMessage.setAttribute("style", "height: 30px; background-image: url(./img/1.gif); background-repeat: no-repeat; margin-left: 165px; margin-top: 15px;");
      }).then(function () {
        setTimeout(function () {
        ...
        return statusMessage.setAttribute("style", "height: 30px; background-image: url(./img/error.png); background-repeat: no-repeat; margin-left: 165px; margin-top: 15px;");
      }).then(clearInput);
    });
  };
...
var modal = function modal() {
  ...
  var show = function show(overlayStatus, overflowStatus, classListMethod, el) {
...
var tabs = function tabs() {
  var tabWrapper = document.querySelector('.info-header'),
...
var timer = function timer() {
  var timeToEnd = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '2019-05-18';
  var tagHtmlForSmoothyScroll = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'html';
  var html = document.querySelector(tagHtmlForSmoothyScroll);
  ...
  var setClock = function setClock() {
    var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'timer';
    var endTime = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : timeToEnd;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var tabs = __webpack_require__(/*! ./parts/tabs.js */ "./src/js/parts/tabs.js"),
      ...
      ajaxForm = __webpack_require__(/*! ./parts/ajaxForm.js */ "./src/js/parts/ajaxForm.js"),

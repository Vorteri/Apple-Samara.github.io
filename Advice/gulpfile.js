...
gulp.task('scripts', function() {
	return gulp.src([
		...
		'app/libs/jquery.maskedinput.min.js' // Берем jQuery, через кому писати які файли збирати до купи
		])
...
//	var buildCss = gulp.src('app/css/style.min.css') // Переносим библиотеки в продакшен. Тут можна добавити пару файлів ось так: [, 'app/css/libs.min.css']
